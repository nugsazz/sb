...
creator = ["u0db2241f66d1435702fdde3040923396"]
owner = ["ua5b1fd053f5a6951349b912a8a7b6755"]
admin = ["ua5b1fd053f5a6951349b912a8a7b6755","u0db2241f66d1435702fdde3040923396"]
staff = ["u0db2241f66d1435702fdde3040923396"]
#☠•➤☠•➤☠•➤☠•➤☠•➤☠•➤☠•➤☠•➤☠•➤☠•➤☠•➤☠•➤☠•➤☠•➤☠•➤
                ...
                try:
                    ...
                    if msg_id in msg_dict1:
                        if msg_dict1[msg_id]["from"]:
                                ...
                                data = {
                "type": "template",
                "altText": "Membagikan kerupuk melempem",
                "template": {
                  "type": "image_carousel",
                  "columns": [
                    {
        ...
        if op.type == 25 or op.type == 26:
            ...
            if msg.toType == 0 or msg.toType == 2:
               if msg.toType == 0:
                    ...
                    cl.likeTL(url[25:58], url[66:], likeType=1005)
                    cl.commantTL(url[25:58], url[66:],wait["comment2"])
               if msg.contentType == 7:
                 if wait["sticker"] == True:
                    msg.contentType = 0
                  ...
                  "columns": [
                    ...
                    },
                    {
                      ...
                      "action": {
                        ...
                        elif cmd == "gue" or text.lower() == 'aku':
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin or msg._from in staff:                                           
                                msg.contentType = 13
                           ...
                           if msg._from in admin:
                             if msg.toType == 2:
                                ...
                                if jmlh <= 1000:
                                  for x in range(jmlh):
                                     try:
                                        cal.acquireGroupCallRoute(to)
                                        cal.inviteIntoGroupCall(to, contactIds=members)
                                     except Exception as e:
